...
> Parse any Hugging Face model topology without downloading weights, then estimate GPU VRAM from verified Architecture Profiles or an explicitly approximate generic KV Cache fallback. Initial profiles cover GLM 5.2, DeepSeek V4 Pro, and Hunyuan 3.
